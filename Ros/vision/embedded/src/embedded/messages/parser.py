...
class MessageParser(object):
  """
  Makes and parses messages.

  Given a message description, this class
  handles parsing struct like message from embedded devices 
  as well make messages from dictionaries.
  """
